...
@DisplayName("체크 19위 노리2 체크카드(Global)")
class CheckRank019Card2423BenefitTest {
    ...
    @Test
    @DisplayName("OTT/영화/문화: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
    void classifiesBenefit009() {
        // 계산하지 않는 상세도 누락하지 않고 원본 분류 상태와 제외·검토 사유를 고정한다.
        fixture.assertSourceDetail(
                /* 카드고릴라 카드 ID */ "2423",
                /* 카드 내 혜택 순번 */ 9,
                /* benefit_title */ "OTT/영화/문화",
                /* 계산 지원 상태 */ "ONLINE_OR_INDIRECT_EXCLUDED",
                /* 분류 사유 */ "온라인·앱·배달·간편결제·자동납부 전용 혜택");
    }
    ...
    void rejectsBenefit011WhenCategoryIsNotMatched() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit011Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
