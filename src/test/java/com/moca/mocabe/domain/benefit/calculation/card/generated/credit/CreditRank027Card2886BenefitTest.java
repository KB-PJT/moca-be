...
@DisplayName("신용 27위 삼성 iD SELECT ON 카드")
class CreditRank027Card2886BenefitTest {
    ...
    @Test
    @DisplayName("일반음식점: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("일반음식점: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("일반음식점: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("일반음식점: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("일반음식점: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    /**
     * benefit_title=일반음식점의 계산 조건을 만든다.
     *
