...
@DisplayName("체크 6위 네이버페이 머니카드")
class CheckRank006Card2626BenefitTest {
    ...
    @Test
    @DisplayName("여행/숙박: 직접 카드 결제 계산 규칙 검토 필요 - 계산 가능한 할인/캐시백/포인트/마일리지 패턴을 자동 추출하지 못함")
