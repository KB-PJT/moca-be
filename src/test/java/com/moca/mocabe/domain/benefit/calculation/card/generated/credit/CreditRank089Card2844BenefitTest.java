...
@DisplayName("신용 89위 현대카드 ZERO Up(할인형)")
class CreditRank089Card2844BenefitTest {
    ...
    void floorsBenefit003FractionalReward() {
        ...
        // 카드 혜택은 원 미만 금액을 올림하지 않고 버린 결과와 같아야 한다.
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("160", result.rawRewardValue());
    }
