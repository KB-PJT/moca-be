...
@DisplayName("체크 8위 하나 나라사랑카드")
class CheckRank008Card2934BenefitTest {
    ...
    @Test
    @DisplayName("실적조건 없음: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("실적조건 없음: 최소 결제금액 30,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("실적조건 없음: 최소 결제금액 30,000원부터 적용한다")
    ...
    @Test
    @DisplayName("실적조건 없음: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("실적조건 없음: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("실적조건 없음: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("실적조건 없음: 정률 혜택의 원 미만 금액을 절사한다")
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("9000", result.rawRewardValue());
    }

    @Test
    @DisplayName("급여이체: 20% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("급여이체: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("급여이체: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("급여이체: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("급여이체: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("급여이체: 월 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("급여이체: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("급여이체: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("할인: 최소 결제금액 10,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("할인: 최소 결제금액 10,000원부터 적용한다")
    ...
    @Test
    @DisplayName("할인: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("할인: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("할인: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("혜택 프로모션: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
    void classifiesBenefit005() {
        // 계산하지 않는 상세도 누락하지 않고 원본 분류 상태와 제외·검토 사유를 고정한다.
        fixture.assertSourceDetail(
                /* 카드고릴라 카드 ID */ "2934",
                /* 카드 내 혜택 순번 */ 5,
                /* benefit_title */ "혜택 프로모션",
                /* 계산 지원 상태 */ "INFORMATION_ONLY",
                /* 분류 사유 */ "바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택");
    }

    /**
     * benefit_title=실적조건 없음의 계산 조건을 만든다.
     *
    ...
    /**
     * benefit_title=급여이체의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
