...
@DisplayName("신용 66위 하나 스카이패스 아멕스 플래티늄 카드")
class CreditRank066Card2237BenefitTest {
    ...
    @Test
    @DisplayName("공항라운지: 500000마일 정액 마일리지 정상 적용")
    ...
    @Test
    @DisplayName("공항라운지: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("공항라운지: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("공항라운지: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("공항라운지: 월 1회 사용 후에는 적용하지 않는다")
    ...
    /**
     * benefit_title=공항라운지의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
