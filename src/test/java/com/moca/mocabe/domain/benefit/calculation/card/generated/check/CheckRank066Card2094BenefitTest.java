...
@DisplayName("체크 66위 카카오페이 체크카드")
class CheckRank066Card2094BenefitTest {
    ...
    @Test
    @DisplayName("카카오페이: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
    ...
    @Test
    @DisplayName("편의점: 전월 실적 150,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("편의점: 전월 실적 150,000원부터 적용한다")
    ...
    @Test
    @DisplayName("편의점: 월 2회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("편의점: 월 2회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("기타: 2000원 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("기타: 전월 실적 150,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("기타: 전월 실적 150,000원부터 적용한다")
    ...
    @Test
    @DisplayName("기타: 월 2회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("기타: 월 2회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("기타: 제외 가맹점에서는 적용하지 않는다")
    ...
    void capsBenefit004FixedDiscountAtPaymentAmount() {
    ...
    @Test
    @DisplayName("영화: 전월 실적 150,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("영화: 전월 실적 150,000원부터 적용한다")
    ...
    void capsBenefit005FixedDiscountAtPaymentAmount() {
        // 정액 할인액보다 작은 결제금액으로 결제금액 초과 할인 방지 정책을 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit005Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("카페: 전월 실적 150,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페: 전월 실적 150,000원부터 적용한다")
    ...
    @Test
    @DisplayName("패스트푸드: 전월 실적 150,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("패스트푸드: 전월 실적 150,000원부터 적용한다")
    ...
    @Test
    @DisplayName("패스트푸드: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("패스트푸드: 제외 가맹점에서는 적용하지 않는다")
