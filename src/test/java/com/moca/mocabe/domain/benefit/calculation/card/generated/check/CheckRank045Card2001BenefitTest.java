...
@DisplayName("체크 45위 꿀카드")
class CheckRank045Card2001BenefitTest {
    ...
    @Test
    @DisplayName("음원사이트: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
    ...
    @Test
    @DisplayName("수수료우대: 1.0999999999999999% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("수수료우대: 제외 가맹점에서는 적용하지 않는다")
