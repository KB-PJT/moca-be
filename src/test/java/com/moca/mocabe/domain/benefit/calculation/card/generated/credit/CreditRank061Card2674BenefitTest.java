...
@DisplayName("신용 61위 I-Mileage (대한항공)")
class CreditRank061Card2674BenefitTest {
    ...
    @Test
    @DisplayName("대한항공: 1000마일 정액 마일리지 정상 적용")
    ...
    @Test
    @DisplayName("공항: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
    ...
    @Test
    @DisplayName("카페: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("카페: 월 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페: 정액 할인은 결제금액을 초과하지 않는다")
