...
@DisplayName("체크 77위 카드의정석 칼퇴 CHECK")
class CheckRank077Card2760BenefitTest {
    ...
    @Test
    @DisplayName("푸드: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("푸드: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("푸드: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("푸드: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("푸드: 월 3회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("푸드: 월 3회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("뷰티/피트니스: 5% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("뷰티/피트니스: 최소 결제금액 10,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("뷰티/피트니스: 최소 결제금액 10,000원부터 적용한다")
    ...
    @Test
    @DisplayName("뷰티/피트니스: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("뷰티/피트니스: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("뷰티/피트니스: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("뷰티/피트니스: 월 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("뷰티/피트니스: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("교통: 최소 결제금액 10,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("교통: 최소 결제금액 10,000원부터 적용한다")
    ...
    @Test
    @DisplayName("교통: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("교통: 월 1회 사용 후에는 적용하지 않는다")
