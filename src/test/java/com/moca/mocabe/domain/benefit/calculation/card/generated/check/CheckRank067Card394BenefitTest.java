...
@DisplayName("체크 67위 삼성체크카드 & CASHBACK")
class CheckRank067Card394BenefitTest {
    ...
    @Test
    @DisplayName("모든가맹점: 0.6% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("모든가맹점: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("모든가맹점: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("모든가맹점: 월 1회 사용 후에는 적용하지 않는다")
    ...
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("60", result.rawRewardValue());
    }
    ...
    @Test
    @DisplayName("테마파크: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("테마파크: 일 1회 사용 후에는 적용하지 않는다")
