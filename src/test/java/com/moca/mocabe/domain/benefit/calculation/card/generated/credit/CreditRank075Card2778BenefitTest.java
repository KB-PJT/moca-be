...
@DisplayName("신용 75위 IBK포인트3.8(신용)")
class CreditRank075Card2778BenefitTest {
    ...
    @Test
    @DisplayName("국내외가맹점: 1.5% 포인트 정상 적용")
