...
@DisplayName("체크 61위 I-Travel(체크)")
class CheckRank061Card2866BenefitTest {
    ...
    @Test
    @DisplayName("대한항공: 3,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("대한항공: 최소 결제금액 30,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("대한항공: 최소 결제금액 30,000원부터 적용한다")
    ...
    void excludesBenefit004AmountBelowNextSpendUnit() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("10", result.rawRewardValue());
    }
    ...
    void appliesBenefit004AtNextSpendUnit() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("11", result.rawRewardValue());
    }
