...
@DisplayName("신용 31위 삼성 iD SELECT UP 카드")
class CreditRank031Card2986BenefitTest {
    ...
    @Test
    @DisplayName("국내가맹점: 0.5% 할인 정상 적용")
    ...
    @Test
    @DisplayName("수수료우대: 1.0999999999999999% 할인 정상 적용")
    ...
    void floorsBenefit004FractionalReward() {
        ...
        // 카드 혜택은 원 미만 금액을 올림하지 않고 버린 결과와 같아야 한다.
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("110", result.rawRewardValue());
    }
