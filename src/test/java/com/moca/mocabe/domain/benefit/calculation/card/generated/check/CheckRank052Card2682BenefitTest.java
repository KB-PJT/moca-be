...
@DisplayName("체크 52위 K-패스 하나 체크카드")
class CheckRank052Card2682BenefitTest {
    ...
    @Test
    @DisplayName("드럭스토어: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("드럭스토어: 전월 실적 300,000원부터 적용한다")
