...
@DisplayName("체크 86위 카카오뱅크 개인사업자 체크카드")
class CheckRank086Card2421BenefitTest {
    ...
    @Test
    @DisplayName("비즈니스: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("비즈니스: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("비즈니스: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("비즈니스: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    /**
     * benefit_title=비즈니스의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
