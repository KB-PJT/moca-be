...
@DisplayName("체크 69위 케이뱅크 플러스 체크카드")
class CheckRank069Card669BenefitTest {

    private final CardBenefitTestFixture fixture = new CardBenefitTestFixture();

    @Test
    @DisplayName("모든가맹점: 0.3% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("모든가맹점: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("모든가맹점: 일 1회 사용 후에는 적용하지 않는다")
