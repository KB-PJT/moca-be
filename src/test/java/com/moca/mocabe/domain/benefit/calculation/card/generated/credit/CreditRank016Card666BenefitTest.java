...
@DisplayName("신용 16위 올바른 FLEX 카드")
class CreditRank016Card666BenefitTest {
    ...
    @Test
    @DisplayName("기타: 7.000000000000001% 할인 정상 적용")
    ...
    @Test
    @DisplayName("기타: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("기타: 월 1회 사용 후에는 적용하지 않는다")
