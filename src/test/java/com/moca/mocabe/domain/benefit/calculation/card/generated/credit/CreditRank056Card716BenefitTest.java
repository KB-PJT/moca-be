...
@DisplayName("신용 56위 메리어트 본보이™ 더 베스트 신한카드")
class CreditRank056Card716BenefitTest {
    ...
    @Test
    @DisplayName("호텔: 50000P 정액 포인트 정상 적용")
    ...
    @Test
    @DisplayName("호텔: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("호텔: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 1,000원당 5마일 적립 정상 적용")
    ...
    void appliesBenefit002AtNextSpendUnit() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("5", result.rawRewardValue());
    }

    @Test
    @DisplayName("적립: 직접 카드 결제 계산 규칙 검토 필요 - 계산 가능한 할인/캐시백/포인트/마일리지 패턴을 자동 추출하지 못함")
    ...
    @Test
    @DisplayName("공항라운지: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
