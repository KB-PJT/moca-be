...
@DisplayName("체크 2위 ONE 체크카드")
class CheckRank002Card2749BenefitTest {
    ...
    @Test
    @DisplayName("대중교통: 53% 마일리지 정상 적용")
    ...
    @Test
    @DisplayName("대중교통: 월 15회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("대중교통: 월 15회 사용 후에는 적용하지 않는다")
    ...
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("5300", result.rawRewardValue());
    }

    @Test
    @DisplayName("대중교통: 3000원 정액 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("대중교통: 최소 결제금액 50,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("대중교통: 최소 결제금액 50,000원부터 적용한다")
    ...
    @Test
    @DisplayName("대중교통: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("캐시백: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("캐시백: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("캐시백: 직접 카드 결제 계산 규칙 검토 필요 - 선택형/자동맞춤/배수/특수 조건은 별도 사용자 선택 또는 집계가 필요함")
    ...
    @Test
    @DisplayName("캐시백: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("캐시백: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("기타: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
