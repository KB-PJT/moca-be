...
@DisplayName("체크 13위 K-패스카드(체크)")
class CheckRank013Card2561BenefitTest {
    ...
    @Test
    @DisplayName("교통: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("통신: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("통신: 최소 결제금액 10,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("통신: 최소 결제금액 10,000원부터 적용한다")
    ...
    @Test
    @DisplayName("통신: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("통신: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("통신: 정률 혜택의 원 미만 금액을 절사한다")
