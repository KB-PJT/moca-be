...
@DisplayName("신용 47위 대한항공카드 120")
class CreditRank047Card2710BenefitTest {
    ...
    @Test
    @DisplayName("항공권: 50000마일 정액 마일리지 정상 적용")
