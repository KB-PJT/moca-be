...
@DisplayName("신용 98위 신한카드 The BEST+")
class CreditRank098Card993BenefitTest {

    private final CardBenefitTestFixture fixture = new CardBenefitTestFixture();

    @Test
    @DisplayName("바우처: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
    ...
    @Test
    @DisplayName("항공마일리지: 1,500원당 1.5마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("항공마일리지: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("항공마일리지: 다음 결제 단위보다 1원 적은 금액은 추가 적립하지 않는다")
    ...
    @Test
    @DisplayName("항공마일리지: 다음 결제 단위 경계값부터 추가 혜택을 적용한다")
    ...
    @Test
    @DisplayName("골프: 100000원 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("골프: 정액 할인은 결제금액을 초과하지 않는다")
    ...
    @Test
    @DisplayName("호텔: 300000마일 정액 마일리지 정상 적용")
    ...
    @Test
    @DisplayName("호텔: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("호텔: 월 1회 사용 후에는 적용하지 않는다")
    ...
    /**
     * benefit_title=항공마일리지의 계산 조건을 만든다.
     *
