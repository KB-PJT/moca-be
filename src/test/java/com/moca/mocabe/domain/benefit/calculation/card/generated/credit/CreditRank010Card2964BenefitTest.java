...
@DisplayName("신용 10위 KB NEED Pay 카드")
class CreditRank010Card2964BenefitTest {
    ...
    @Test
    @DisplayName("기타: 전월 실적 350,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("기타: 전월 실적 350,000원부터 적용한다")
    ...
    @Test
    @DisplayName("기타: 월 한도가 1원 남았으면 1원만 적용한다")
    void appliesOnlyRemainingMonthlyLimitForBenefit005() {
        // 월 한도에서 이미 사용한 혜택을 빼고 1원만 남은 상태로 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit005Rule(/* 이번 달에 이미 사용한 혜택 */ "399999"),
                fixture.context(
                        /* 결제금액 */ "100000",
                        /* 리터·횟수 등 사용량 */ "0",
                        /* 전월 실적 */ "10000000",
    ...
    @Test
    @DisplayName("기타: 월 한도를 모두 사용했으면 적용하지 않는다")
    void rejectsBenefit005WhenMonthlyLimitIsExhausted() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit005Rule(/* 이번 달에 이미 사용한 혜택 */ "400000"),
                fixture.context(
                        /* 결제금액 */ "100000",
                        /* 리터·횟수 등 사용량 */ "0",
                        /* 전월 실적 */ "10000000",
