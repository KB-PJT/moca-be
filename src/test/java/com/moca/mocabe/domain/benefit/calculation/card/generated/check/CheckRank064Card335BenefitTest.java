...
@DisplayName("체크 64위 청춘대로 싱글 체크카드")
class CheckRank064Card335BenefitTest {
    ...
    @Test
    @DisplayName("소셜커머스: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("소셜커머스: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("소셜커머스: 1회 인정금액 20,000원 초과분은 혜택에서 제외한다")
    ...
    @Test
    @DisplayName("소셜커머스: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("소셜커머스: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("소셜커머스: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("교통: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("교통: 1회 인정금액 20,000원 초과분은 혜택에서 제외한다")
    ...
    @Test
    @DisplayName("애완동물: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("애완동물: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("애완동물: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("애완동물: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("애완동물: 1회 인정금액 50,000원 초과분은 혜택에서 제외한다")
    ...
    @Test
    @DisplayName("애완동물: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("애완동물: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("애완동물: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("해외이용: 300000원 정액 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("해외이용: 최소 결제금액 30,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("해외이용: 최소 결제금액 30,000원부터 적용한다")
    ...
    @Test
    @DisplayName("해외이용: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("여행/숙박: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("여행/숙박: 전월 실적 300,000원부터 적용한다")
    ...
    /**
     * benefit_title=소셜커머스의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
    ...
    /**
     * benefit_title=애완동물의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
