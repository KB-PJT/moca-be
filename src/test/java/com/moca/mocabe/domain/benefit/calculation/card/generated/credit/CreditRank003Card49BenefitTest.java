...
@DisplayName("신용 3위 삼성카드 & MILEAGE PLATINUM (스카이패스)")
class CreditRank003Card49BenefitTest {
    ...
    @Test
    @DisplayName("백화점: 1,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("백화점: 다음 결제 단위보다 1원 적은 금액은 추가 적립하지 않는다")
    ...
    @Test
    @DisplayName("백화점: 다음 결제 단위 경계값부터 추가 혜택을 적용한다")
    ...
    @Test
    @DisplayName("주유소: 1,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("주유소: 다음 결제 단위보다 1원 적은 금액은 추가 적립하지 않는다")
    void excludesBenefit003AmountBelowNextSpendUnit() {
        // 다음 적립 단위에 1원 모자란 결제금액으로 불완전한 단위가 버려지는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit003Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("주유소: 다음 결제 단위 경계값부터 추가 혜택을 적용한다")
    void appliesBenefit003AtNextSpendUnit() {
        // 다음 적립 단위와 정확히 같은 결제금액으로 추가 혜택 시작 경계를 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit003Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("카페: 1,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("카페: 다음 결제 단위보다 1원 적은 금액은 추가 적립하지 않는다")
    ...
    @Test
    @DisplayName("카페: 다음 결제 단위 경계값부터 추가 혜택을 적용한다")
    ...
    @Test
    @DisplayName("편의점: 1,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("편의점: 다음 결제 단위보다 1원 적은 금액은 추가 적립하지 않는다")
    void excludesBenefit005AmountBelowNextSpendUnit() {
        // 다음 적립 단위에 1원 모자란 결제금액으로 불완전한 단위가 버려지는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit005Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("편의점: 다음 결제 단위 경계값부터 추가 혜택을 적용한다")
    void appliesBenefit005AtNextSpendUnit() {
        // 다음 적립 단위와 정확히 같은 결제금액으로 추가 혜택 시작 경계를 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit005Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("택시: 1,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("택시: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("택시: 다음 결제 단위보다 1원 적은 금액은 추가 적립하지 않는다")
    void excludesBenefit006AmountBelowNextSpendUnit() {
        // 다음 적립 단위에 1원 모자란 결제금액으로 불완전한 단위가 버려지는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit006Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("택시: 다음 결제 단위 경계값부터 추가 혜택을 적용한다")
    void appliesBenefit006AtNextSpendUnit() {
        // 다음 적립 단위와 정확히 같은 결제금액으로 추가 혜택 시작 경계를 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit006Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("해외: 1,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("해외: 다음 결제 단위보다 1원 적은 금액은 추가 적립하지 않는다")
    void excludesBenefit007AmountBelowNextSpendUnit() {
        // 다음 적립 단위에 1원 모자란 결제금액으로 불완전한 단위가 버려지는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit007Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("해외: 다음 결제 단위 경계값부터 추가 혜택을 적용한다")
    void appliesBenefit007AtNextSpendUnit() {
        // 다음 적립 단위와 정확히 같은 결제금액으로 추가 혜택 시작 경계를 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit007Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
