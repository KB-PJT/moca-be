...
@DisplayName("신용 13위 THE iD. 1st")
class CreditRank013Card2915BenefitTest {
    ...
    @Test
    @DisplayName("프리미엄: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("프리미엄: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("프리미엄: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("프리미엄: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("프리미엄: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("프리미엄: 지정 결제 채널이 아니면 적용하지 않는다")
