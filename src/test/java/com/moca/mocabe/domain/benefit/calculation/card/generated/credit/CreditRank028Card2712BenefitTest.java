...
@DisplayName("신용 28위 대한항공카드 the First Edition2")
class CreditRank028Card2712BenefitTest {

    private final CardBenefitTestFixture fixture = new CardBenefitTestFixture();

    @Test
    @DisplayName("대한항공: 1,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("대한항공: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("대한항공: 전월 실적 500,000원부터 적용한다")
    ...
    void excludesBenefit001AmountBelowNextSpendUnit() {
    ...
    void appliesBenefit001AtNextSpendUnit() {
    ...
    @Test
    @DisplayName("적립: 1,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("적립: 다음 결제 단위보다 1원 적은 금액은 추가 적립하지 않는다")
    ...
    @Test
    @DisplayName("적립: 다음 결제 단위 경계값부터 추가 혜택을 적용한다")
    ...
    @Test
    @DisplayName("항공권: 200000마일 정액 마일리지 정상 적용")
    ...
    @Test
    @DisplayName("항공권: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("항공권: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("항공권: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("프리미엄: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
