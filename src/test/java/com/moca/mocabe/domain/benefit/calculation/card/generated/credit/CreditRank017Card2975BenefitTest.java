...
@DisplayName("신용 17위 LOCA LIKIT 1.5")
class CreditRank017Card2975BenefitTest {
    ...
    @Test
    @DisplayName("국내가맹점: 0.8% 할인 정상 적용")
