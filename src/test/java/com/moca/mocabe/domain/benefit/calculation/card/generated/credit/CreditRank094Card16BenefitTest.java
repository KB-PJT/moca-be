...
@DisplayName("신용 94위 신한카드 RPM+ Platinum#")
class CreditRank094Card16BenefitTest {
    ...
    @Test
    @DisplayName("주유: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("주유: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("주유: 제외 가맹점에서는 적용하지 않는다")
    ...
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("200", result.rawRewardValue());
    }

    @Test
    @DisplayName("쇼핑: 5% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("쇼핑: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("쇼핑: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("마트/편의점: 5% 포인트 정상 적용")
    void appliesBenefit003() {
        // 테스트에 사용한 계산 규칙이 카드고릴라의 해당 혜택 상세에서 만들어졌는지 확인한다.
        fixture.assertSourceDetail(
                /* 카드고릴라 카드 ID */ "16",
                /* 카드 내 혜택 순번 */ 3,
                /* benefit_title */ "마트/편의점",
                /* 계산 지원 상태 */ "DIRECT_OFFLINE_CALCULABLE",
                /* 분류 사유 */ "직접 카드 결제 혜택 산식 계산 가능");
    ...
    @Test
    @DisplayName("마트/편의점: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("마트/편의점: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("마트/편의점: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("마트/편의점: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("마트/편의점: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("마트/편의점: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("택시: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("택시: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("택시: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("택시: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("택시: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("정비: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("정비: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("정비: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("정비: 지정 결제 채널이 아니면 적용하지 않는다")
    void rejectsBenefit005WhenPaymentChannelIsNotEligible() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit005Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("정비: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("국내외가맹점: 5% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("국내외가맹점: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("국내외가맹점: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("국내외가맹점: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("국내외가맹점: 제외 가맹점에서는 적용하지 않는다")
    void rejectsBenefit006WhenMerchantIsNotEligible() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit006Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("국내외가맹점: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("국내외가맹점: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("프리미엄: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("프리미엄: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("프리미엄: 일 1회 한도의 마지막 허용 거래는 적용한다")
    void appliesBenefit007WhenDailyUsageIsLastAllowed() {
        // 적용 가능한 마지막 경계값 또는 최초 경계값을 결제 상황에 넣어 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit007Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("프리미엄: 일 1회 사용 후에는 적용하지 않는다")
    void rejectsBenefit007WhenDailyUsageLimitIsExhausted() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit007Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("프리미엄: 월 3회 한도의 마지막 허용 거래는 적용한다")
    void appliesBenefit007WhenMonthlyUsageIsLastAllowed() {
        // 적용 가능한 마지막 경계값 또는 최초 경계값을 결제 상황에 넣어 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit007Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("프리미엄: 월 3회 사용 후에는 적용하지 않는다")
    void rejectsBenefit007WhenMonthlyUsageLimitIsExhausted() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit007Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("프리미엄: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    /**
     * benefit_title=마트/편의점의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
    ...
    /**
     * benefit_title=국내외가맹점의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
    ...
    /**
     * benefit_title=프리미엄의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
