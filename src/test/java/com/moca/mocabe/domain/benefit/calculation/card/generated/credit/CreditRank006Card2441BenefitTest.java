...
@DisplayName("신용 6위 KB국민 My WE:SH 카드")
class CreditRank006Card2441BenefitTest {
    ...
    @Test
    @DisplayName("푸드: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("푸드: 전월 실적 400,000원부터 적용한다")
    ...
    void appliesOnlyRemainingMonthlyLimitForBenefit008() {
        // 월 한도에서 이미 사용한 혜택을 빼고 1원만 남은 상태로 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit008Rule(/* 이번 달에 이미 사용한 혜택 */ "399999"),
                fixture.context(
                        /* 결제금액 */ "100000",
                        /* 리터·횟수 등 사용량 */ "0",
                        /* 전월 실적 */ "10000000",
    ...
    void rejectsBenefit008WhenMonthlyLimitIsExhausted() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit008Rule(/* 이번 달에 이미 사용한 혜택 */ "400000"),
                fixture.context(
                        /* 결제금액 */ "100000",
                        /* 리터·횟수 등 사용량 */ "0",
                        /* 전월 실적 */ "10000000",
    ...
    @Test
    @DisplayName("선택형: 직접 카드 결제 계산 규칙 검토 필요 - 계산 가능한 할인/캐시백/포인트/마일리지 패턴을 자동 추출하지 못함")
