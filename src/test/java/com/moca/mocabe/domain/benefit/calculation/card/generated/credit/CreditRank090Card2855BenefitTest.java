...
@DisplayName("신용 90위 Haru(Hoshino Resorts)")
class CreditRank090Card2855BenefitTest {
    ...
    @Test
    @DisplayName("해외이용: 3.5000000000000004% 포인트 정상 적용")
    ...
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("350", result.rawRewardValue());
    }
    ...
    @Test
    @DisplayName("적립: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("리조트: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("리조트: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("리조트: 정률 혜택의 원 미만 금액을 절사한다")
