...
@DisplayName("체크 21위 신한카드 나라사랑카드 체크")
class CheckRank021Card2933BenefitTest {
    ...
    @Test
    @DisplayName("캐시백: 최소 결제금액 30,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("캐시백: 최소 결제금액 30,000원부터 적용한다")
    ...
    @Test
    @DisplayName("캐시백: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("캐시백: 전월 실적 100,000원부터 적용한다")
    ...
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("6000", result.rawRewardValue());
    }
    ...
    @Test
    @DisplayName("캐시백: 1회 인정금액 5,000원 초과분은 혜택에서 제외한다")
    ...
    @Test
    @DisplayName("캐시백: 월 5회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("캐시백: 월 5회 사용 후에는 적용하지 않는다")
