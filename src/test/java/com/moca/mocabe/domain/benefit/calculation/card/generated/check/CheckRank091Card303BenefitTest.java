...
@DisplayName("체크 91위 GS칼텍스 신한카드 경차사랑 체크")
class CheckRank091Card303BenefitTest {
    ...
    @Test
    @DisplayName("자동차: 직접 카드 결제 계산 규칙 검토 필요 - 상세 조건에서 완전한 계산 산식을 추출하지 못함")
    ...
    @Test
    @DisplayName("주유: 사용 단위당 30원 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("주유: 사용량이 0이면 혜택도 0으로 계산한다")
    void calculatesZeroBenefit002ForZeroUsage() {
    ...
    @Test
    @DisplayName("보험: 30000원 정액 캐시백 정상 적용")
