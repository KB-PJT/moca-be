...
@DisplayName("체크 54위 K-패스(체크)")
class CheckRank054Card2562BenefitTest {
    ...
    @Test
    @DisplayName("대중교통: 100원 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("대중교통: 월 10회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("대중교통: 월 10회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("테마파크: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("테마파크: 전월 실적 300,000원부터 적용한다")
