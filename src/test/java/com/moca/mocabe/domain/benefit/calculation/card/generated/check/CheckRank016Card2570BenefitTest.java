...
@DisplayName("체크 16위 카드의정석 오하CHECK")
class CheckRank016Card2570BenefitTest {
    ...
    @Test
    @DisplayName("생활: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("카페: 1회 인정금액 1,000원 초과분은 혜택에서 제외한다")
    ...
    @Test
    @DisplayName("대중교통: 1회 인정금액 1,000원 초과분은 혜택에서 제외한다")
    void capsBenefit006BenefitBaseAmount() {
        // 1회 인정금액과 정확히 같은 결제의 혜택을 계산한다.
        BenefitCalculationResult atLimit = fixture.calculator.calculate(
                benefit006Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("해외: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("해외: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("생활: 1회 인정금액 1,000원 초과분은 혜택에서 제외한다")
    void capsBenefit009BenefitBaseAmount() {
        // 1회 인정금액과 정확히 같은 결제의 혜택을 계산한다.
        BenefitCalculationResult atLimit = fixture.calculator.calculate(
                benefit009Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("공연/전시: 1회 인정금액 1,000원 초과분은 혜택에서 제외한다")
    void capsBenefit011BenefitBaseAmount() {
        // 1회 인정금액과 정확히 같은 결제의 혜택을 계산한다.
        BenefitCalculationResult atLimit = fixture.calculator.calculate(
                benefit011Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
