...
@DisplayName("신용 82위 zgm.휴가중카드")
class CreditRank082Card2464BenefitTest {
    ...
    @Test
    @DisplayName("해외: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("해외: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("국내가맹점: 0.5% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("국내가맹점: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("국내가맹점: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("국내가맹점: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("호텔: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("호텔: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("호텔: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("호텔: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    /**
     * benefit_title=국내가맹점의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
