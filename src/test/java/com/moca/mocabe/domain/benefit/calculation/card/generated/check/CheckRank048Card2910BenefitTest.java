...
@DisplayName("체크 48위 카카오뱅크 스마트 하이패스카드")
class CheckRank048Card2910BenefitTest {
    ...
    @Test
    @DisplayName("하이패스: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("하이패스: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("하이패스: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    /**
     * benefit_title=하이패스의 계산 조건을 만든다.
     *
