...
@DisplayName("신용 99위 KB ALL point 카드")
class CreditRank099Card769BenefitTest {
    ...
    @Test
    @DisplayName("적립: 0.7000000000000001% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("할인: 1.7000000000000002% 캐시백 정상 적용")
    ...
    void floorsBenefit006FractionalReward() {
        ...
        // 카드 혜택은 원 미만 금액을 올림하지 않고 버린 결과와 같아야 한다.
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("170", result.rawRewardValue());
    }
