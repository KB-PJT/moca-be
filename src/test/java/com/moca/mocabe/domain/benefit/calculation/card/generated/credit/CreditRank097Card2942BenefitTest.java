...
@DisplayName("신용 97위 에너지플러스 현대카드")
class CreditRank097Card2942BenefitTest {
    ...
    @Test
    @DisplayName("주유: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("주유: 전월 실적 400,000원부터 적용한다")
    ...
    @Test
    @DisplayName("주유: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
