...
@DisplayName("체크 57위 롯데 국민행복 체크카드")
class CheckRank057Card404BenefitTest {

    private final CardBenefitTestFixture fixture = new CardBenefitTestFixture();

    @Test
    @DisplayName("국민행복: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
    ...
    @Test
    @DisplayName("교육/육아: 10% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("교육/육아: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("교육/육아: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("교육/육아: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("교육/육아: 월 2회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("교육/육아: 월 2회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("교육/육아: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("교육/육아: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("교육/육아: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("기타: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("기타: 일 1회 사용 후에는 적용하지 않는다")
    ...
    /**
     * benefit_title=교육/육아의 계산 조건을 만든다.
     *
