...
@DisplayName("신용 92위 JADE Prime")
class CreditRank092Card2703BenefitTest {
    ...
    @Test
    @DisplayName("바우처: 100% 마일리지 정상 적용")
    ...
    @Test
    @DisplayName("바우처: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("바우처: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("바우처: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("바우처: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("바우처: 정률 혜택의 원 미만 금액을 절사한다")
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("10001", result.rawRewardValue());
    }

    @Test
    @DisplayName("바우처: 4000000P 정액 포인트 정상 적용")
    ...
    @Test
    @DisplayName("적립: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("적립: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("적립: 카테고리가 일치하지 않으면 적용하지 않는다")
