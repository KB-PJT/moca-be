...
@DisplayName("신용 57위 IBK포인트(신용)")
class CreditRank057Card2779BenefitTest {

    private final CardBenefitTestFixture fixture = new CardBenefitTestFixture();

    @Test
    @DisplayName("적립: 3.3000000000000003% 포인트 정상 적용")
    ...
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("330", result.rawRewardValue());
    }
