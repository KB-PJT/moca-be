...
@DisplayName("체크 100위 BAZIC(베이직)체크카드")
class CheckRank100Card370BenefitTest {

    private final CardBenefitTestFixture fixture = new CardBenefitTestFixture();

    @Test
    @DisplayName("모든가맹점: 0.3% 할인 정상 적용")
    ...
    @Test
    @DisplayName("모든가맹점: 최소 결제금액 20,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("모든가맹점: 최소 결제금액 20,000원부터 적용한다")
    ...
    @Test
    @DisplayName("모든가맹점: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("모든가맹점: 전월 실적 500,000원부터 적용한다")
