...
@DisplayName("신용 72위 HERITAGE Smart [대한항공 마일리지형]")
class CreditRank072Card2451BenefitTest {
    ...
    @Test
    @DisplayName("바우처: 150000마일 정액 마일리지 정상 적용")
    ...
    @Test
    @DisplayName("국내외가맹점: 1,000원당 1마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("국내외가맹점: 다음 결제 단위보다 1원 적은 금액은 추가 적립하지 않는다")
    ...
    @Test
    @DisplayName("국내외가맹점: 다음 결제 단위 경계값부터 추가 혜택을 적용한다")
