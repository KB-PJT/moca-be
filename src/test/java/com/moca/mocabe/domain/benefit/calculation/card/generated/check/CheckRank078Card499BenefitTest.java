...
@DisplayName("체크 78위 체크카드")
class CheckRank078Card499BenefitTest {
    ...
    @Test
    @DisplayName("적립: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("적립: 월 2회 한도의 마지막 허용 거래는 적용한다")
    void appliesBenefit001WhenMonthlyUsageIsLastAllowed() {
        // 적용 가능한 마지막 경계값 또는 최초 경계값을 결제 상황에 넣어 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit001Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("적립: 월 2회 사용 후에는 적용하지 않는다")
    void rejectsBenefit001WhenMonthlyUsageLimitIsExhausted() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit001Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("적립: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("주유: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("주유: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("주유: 일 2회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("주유: 일 2회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("주유: 월 4회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("주유: 월 4회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 최소 결제금액 20,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 최소 결제금액 20,000원부터 적용한다")
    ...
    void floorsBenefit005FractionalReward() {
        ...
        // 카드 혜택은 원 미만 금액을 올림하지 않고 버린 결과와 같아야 한다.
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("10000", result.rawRewardValue());
    }
