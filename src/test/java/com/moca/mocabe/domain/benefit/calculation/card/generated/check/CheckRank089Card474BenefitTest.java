...
@DisplayName("체크 89위 카카오페이 신한 체크카드(무지)")
class CheckRank089Card474BenefitTest {
    ...
    @Test
    @DisplayName("해외: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("해외: 일 1회 사용 후에는 적용하지 않는다")
