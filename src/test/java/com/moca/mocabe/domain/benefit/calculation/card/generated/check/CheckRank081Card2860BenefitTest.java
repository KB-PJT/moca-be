...
@DisplayName("체크 81위 라이프핏 체크카드")
class CheckRank081Card2860BenefitTest {
    ...
    @Test
    @DisplayName("카페: 월 5회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("카페: 월 5회 사용 후에는 적용하지 않는다")
