...
@DisplayName("신용 12위 대한항공카드 300")
class CreditRank012Card2711BenefitTest {
    ...
    @Test
    @DisplayName("항공권: 100000마일 정액 마일리지 정상 적용")
    ...
    private BenefitRule benefit003Rule(String usedMonthlyValue) {
        return fixture.rule(
                /* 룰 식별자 */ "card-2711-benefit-3",
                /* 할인·캐시백·포인트·마일리지 구분 */ BenefitType.MILEAGE,
                /* 정률·정액·결제 단위·사용량 단위 구분 */ BenefitBasis.FIXED,
                /* 혜택 결과 단위 */ RewardUnit.MILE,
                /* 정률 계산 비율 */ "0",
                /* 정액 또는 단위당 혜택값 */ "100000",
                /* 단위 적립 기준 결제금액 */ "0",
                /* 1회 혜택 인정금액 상한 */ "0",
                /* 혜택 적용 최소 결제금액 */ "0",
                /* 필요한 전월 실적 */ "500000",
