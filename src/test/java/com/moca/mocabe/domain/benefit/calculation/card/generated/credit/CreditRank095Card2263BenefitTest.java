...
@DisplayName("신용 95위 LOCA LIKIT Play")
class CreditRank095Card2263BenefitTest {
    ...
    @Test
    @DisplayName("주유소: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("주유소: 전월 실적 400,000원부터 적용한다")
