...
@DisplayName("신용 63위 zgm.play카드")
class CreditRank063Card2544BenefitTest {
    ...
    @Test
    @DisplayName("영화: 5000원 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("영화: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("영화: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("영화: 월 2회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("영화: 월 2회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페: 최소 결제금액 5,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페: 최소 결제금액 5,000원부터 적용한다")
    ...
    @Test
    @DisplayName("카페: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("카페: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페: 월 2회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("카페: 월 2회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("패스트푸드: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("패스트푸드: 최소 결제금액 5,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("패스트푸드: 최소 결제금액 5,000원부터 적용한다")
    ...
    @Test
    @DisplayName("패스트푸드: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("패스트푸드: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("패스트푸드: 일 1회 한도의 마지막 허용 거래는 적용한다")
    void appliesBenefit005WhenDailyUsageIsLastAllowed() {
        // 적용 가능한 마지막 경계값 또는 최초 경계값을 결제 상황에 넣어 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit005Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("패스트푸드: 일 1회 사용 후에는 적용하지 않는다")
    void rejectsBenefit005WhenDailyUsageLimitIsExhausted() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit005Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("패스트푸드: 월 2회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("패스트푸드: 월 2회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("패스트푸드: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("생활: 최소 결제금액 5,000원보다 1원 적으면 적용하지 않는다")
    void rejectsBenefit006WhenPaymentIsOneWonBelowMinimum() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit006Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("생활: 최소 결제금액 5,000원부터 적용한다")
    void appliesBenefit006WhenPaymentEqualsMinimum() {
        // 적용 가능한 마지막 경계값 또는 최초 경계값을 결제 상황에 넣어 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit006Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("생활: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("생활: 월 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
    ...
    /**
     * benefit_title=패스트푸드의 계산 조건을 만든다.
     *
     * @param usedMonthlyValue 이번 달에 이미 적용받은 혜택 누적값
     * @return 금액·실적·한도·횟수·적용 조건이 구조화된 혜택 룰
     */
