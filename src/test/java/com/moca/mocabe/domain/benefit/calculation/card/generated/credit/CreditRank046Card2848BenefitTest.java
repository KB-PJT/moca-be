...
@DisplayName("신용 46위 카드의정석2")
class CreditRank046Card2848BenefitTest {
    ...
    @Test
    @DisplayName("국내외가맹점: 1.2% 할인 정상 적용")
    ...
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("120", result.rawRewardValue());
    }

    @Test
    @DisplayName("할인: 직접 카드 결제 계산 규칙 검토 필요 - 상세 조건에서 완전한 계산 산식을 추출하지 못함")
