...
@DisplayName("신용 59위 현대카드 Summit")
class CreditRank059Card2692BenefitTest {
    ...
    @Test
    @DisplayName("교육/육아: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("교육/육아: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("교육/육아: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("병원/약국: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("병원/약국: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("여행/숙박: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("여행/숙박: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("여행/숙박: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("골프: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("골프: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("골프: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("골프: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("골프: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("바우처: 2000000P 정액 포인트 정상 적용")
    ...
    private BenefitRule benefit006Rule(String usedMonthlyValue) {
        return fixture.rule(
                /* 룰 식별자 */ "card-2692-benefit-6",
                /* 할인·캐시백·포인트·마일리지 구분 */ BenefitType.POINT,
                /* 정률·정액·결제 단위·사용량 단위 구분 */ BenefitBasis.FIXED,
                /* 혜택 결과 단위 */ RewardUnit.POINT,
                /* 정률 계산 비율 */ "0",
                /* 정액 또는 단위당 혜택값 */ "2000000",
                /* 단위 적립 기준 결제금액 */ "0",
                /* 1회 혜택 인정금액 상한 */ "0",
                /* 혜택 적용 최소 결제금액 */ "0",
                /* 필요한 전월 실적 */ "500000",
