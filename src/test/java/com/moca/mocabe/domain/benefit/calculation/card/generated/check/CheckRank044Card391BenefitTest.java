...
@DisplayName("체크 44위 신한카드 하이패스(전용) 체크")
class CheckRank044Card391BenefitTest {

    private final CardBenefitTestFixture fixture = new CardBenefitTestFixture();

    @Test
    @DisplayName("하이패스: 50% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("하이패스: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("하이패스: 전월 실적 100,000원부터 적용한다")
