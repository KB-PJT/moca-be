...
@DisplayName("체크 4위 신한카드 SOL트래블 체크")
class CheckRank004Card2667BenefitTest {
    ...
    @Test
    @DisplayName("할인: 1회 인정금액 3,000원 초과분은 혜택에서 제외한다")
    ...
    @Test
    @DisplayName("해외이용: 제외 가맹점에서는 적용하지 않는다")
