...
@DisplayName("체크 1위 KB Youth Club 체크카드")
class CheckRank001Card2929BenefitTest {
    ...
    @Test
    @DisplayName("혜택 프로모션: 50% 할인 정상 적용")
    ...
    @Test
    @DisplayName("혜택 프로모션: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("혜택 프로모션: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("혜택 프로모션: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("혜택 프로모션: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("혜택 프로모션: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("혜택 프로모션: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    /**
     * benefit_title=혜택 프로모션의 계산 조건을 만든다.
     *
