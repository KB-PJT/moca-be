...
@DisplayName("신용 21위 JADE Classic")
class CreditRank021Card2657BenefitTest {
    ...
    @Test
    @DisplayName("바우처: 100000P 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("카페: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페: 전월 실적 500,000원부터 적용한다")
