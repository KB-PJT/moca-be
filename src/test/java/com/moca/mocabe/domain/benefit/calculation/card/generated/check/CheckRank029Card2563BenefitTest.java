...
@DisplayName("체크 29위 K-패스 삼성체크카드")
class CheckRank029Card2563BenefitTest {
    ...
    @Test
    @DisplayName("편의점: 직접 카드 결제 계산 규칙 검토 필요 - 상세 조건에서 완전한 계산 산식을 추출하지 못함")
