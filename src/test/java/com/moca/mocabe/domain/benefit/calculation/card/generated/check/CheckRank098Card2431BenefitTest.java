...
@DisplayName("체크 98위 SC제일은행-현대카드 X CHECK")
class CheckRank098Card2431BenefitTest {
    ...
    @Test
    @DisplayName("기타: 1P 정액 캐시백 정상 적용")
