...
@DisplayName("체크 40위 NH트래블리체크카드")
class CheckRank040Card2727BenefitTest {
    ...
    @Test
    @DisplayName("해외: 직접 카드 결제 계산 규칙 검토 필요 - 계산 가능한 할인/캐시백/포인트/마일리지 패턴을 자동 추출하지 못함")
