...
@DisplayName("신용 45위 신한카드 The CLASSIC-Y")
class CreditRank045Card8BenefitTest {
    ...
    @Test
    @DisplayName("주유소: 사용 단위당 60원 할인 정상 적용")
    ...
    @Test
    @DisplayName("면세점: 정률 혜택의 원 미만 금액을 절사한다")
    void floorsBenefit005FractionalReward() {
        ...
        // 카드 혜택은 원 미만 금액을 올림하지 않고 버린 결과와 같아야 한다.
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("800", result.rawRewardValue());
    }

    @Test
    @DisplayName("진에어: 15% 할인 정상 적용")
    ...
    @Test
    @DisplayName("진에어: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("공연/전시: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
