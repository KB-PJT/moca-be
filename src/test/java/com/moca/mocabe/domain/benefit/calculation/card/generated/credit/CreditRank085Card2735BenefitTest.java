...
@DisplayName("신용 85위 신한카드 Edu Plan+")
class CreditRank085Card2735BenefitTest {
    ...
    @Test
    @DisplayName("학원: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("학원: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("학원: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("생활: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("생활: 1회 인정금액 2,000원 초과분은 혜택에서 제외한다")
    ...
    @Test
    @DisplayName("영화: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
