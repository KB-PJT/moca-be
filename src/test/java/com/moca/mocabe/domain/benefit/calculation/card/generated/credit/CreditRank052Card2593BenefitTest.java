...
@DisplayName("신용 52위 zgm.일본여행중 카드")
class CreditRank052Card2593BenefitTest {
    ...
    @Test
    @DisplayName("해외: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("온라인 여행사: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
    void classifiesBenefit003() {
        // 계산하지 않는 상세도 누락하지 않고 원본 분류 상태와 제외·검토 사유를 고정한다.
        fixture.assertSourceDetail(
                /* 카드고릴라 카드 ID */ "2593",
                /* 카드 내 혜택 순번 */ 3,
                /* benefit_title */ "온라인 여행사",
    ...
    @Test
    @DisplayName("적립: 최소 결제금액 10,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 최소 결제금액 10,000원부터 적용한다")
    ...
    @Test
    @DisplayName("적립: 전월 실적 10,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 전월 실적 10,000원부터 적용한다")
