...
@DisplayName("체크 95위 신한카드 SOL글로벌 체크")
class CheckRank095Card2922BenefitTest {
    ...
    @Test
    @DisplayName("할인: 1회 인정금액 1,000원 초과분은 혜택에서 제외한다")
