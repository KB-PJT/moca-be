...
@DisplayName("신용 2위 굿데이카드")
class CreditRank002Card106BenefitTest {
    ...
    @Test
    @DisplayName("주유: 3.5000000000000004% 할인 정상 적용")
    ...
    @Test
    @DisplayName("생활: 전월 실적 600,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 전월 실적 600,000원부터 적용한다")
    ...
    @Test
    @DisplayName("학원: 전월 실적 1,200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("학원: 전월 실적 1,200,000원부터 적용한다")
