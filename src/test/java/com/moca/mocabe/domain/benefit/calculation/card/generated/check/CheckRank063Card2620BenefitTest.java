...
@DisplayName("체크 63위 NH 무럭이 체크카드")
class CheckRank063Card2620BenefitTest {
    ...
    @Test
    @DisplayName("국내외가맹점: 0.2% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("적립: 직접 카드 결제 계산 규칙 검토 필요 - 선택형/자동맞춤/배수/특수 조건은 별도 사용자 선택 또는 집계가 필요함")
