...
@DisplayName("신용 41위 삼성 iD GLOBAL 카드")
class CreditRank041Card2676BenefitTest {
    ...
    @Test
    @DisplayName("수수료우대: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("수수료우대: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("수수료우대: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("수수료우대: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("해외이용: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("해외이용: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("삼성페이: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
    ...
    @Test
    @DisplayName("생활: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("할인: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("할인: 전월 실적 500,000원부터 적용한다")
    ...
    /**
     * benefit_title=수수료우대의 계산 조건을 만든다.
     *
