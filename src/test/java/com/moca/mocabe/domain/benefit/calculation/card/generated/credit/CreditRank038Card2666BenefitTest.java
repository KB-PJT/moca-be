...
@DisplayName("신용 38위 신한카드 Point Plan")
class CreditRank038Card2666BenefitTest {
    ...
    @Test
    @DisplayName("적립: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 전월 실적 400,000원부터 적용한다")
    ...
    @Test
    @DisplayName("적립: 금요일 23시 59분 59초에는 주말 혜택을 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 토요일 00시 정각부터 주말 혜택을 적용한다")
    ...
    @Test
    @DisplayName("적립: 일요일 23시 59분 59초까지 주말 혜택을 적용한다")
    ...
    @Test
    @DisplayName("적립: 월요일 00시 정각부터 주말 혜택을 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("적립: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 금요일 23시 59분 59초에는 주말 혜택을 적용하지 않는다")
    void rejectsBenefit002WhenBeforeWeekend() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit002Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("적립: 토요일 00시 정각부터 주말 혜택을 적용한다")
    void appliesBenefit002WhenAtWeekendStart() {
        // 적용 가능한 마지막 경계값 또는 최초 경계값을 결제 상황에 넣어 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit002Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("적립: 일요일 23시 59분 59초까지 주말 혜택을 적용한다")
    void appliesBenefit002WhenBeforeWeekendEnd() {
        // 적용 가능한 마지막 경계값 또는 최초 경계값을 결제 상황에 넣어 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit002Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("적립: 월요일 00시 정각부터 주말 혜택을 적용하지 않는다")
    void rejectsBenefit002WhenAtWeekendEnd() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit002Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
