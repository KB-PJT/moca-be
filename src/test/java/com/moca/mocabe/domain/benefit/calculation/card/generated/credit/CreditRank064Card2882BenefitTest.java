...
@DisplayName("신용 64위 알파벳카드T")
class CreditRank064Card2882BenefitTest {
    ...
    @Test
    @DisplayName("해외이용: 지정 결제 채널이 아니면 적용하지 않는다")
    ...
    @Test
    @DisplayName("수수료우대: 100% 할인 정상 적용")
    ...
    @Test
    @DisplayName("수수료우대: 지정 결제 채널이 아니면 적용하지 않는다")
