...
@DisplayName("신용 29위 K-패스 (신용)")
class CreditRank029Card2559BenefitTest {
    ...
    @Test
    @DisplayName("대중교통: 300원 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("대중교통: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("대중교통: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("대중교통: 일 3회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("대중교통: 일 3회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("대중교통: 정액 할인은 결제금액을 초과하지 않는다")
    void capsBenefit001FixedDiscountAtPaymentAmount() {
    ...
    @Test
    @DisplayName("교통: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("교통: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("교통: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("교통: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("교통: 월 2회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("교통: 월 2회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("주유소: 사용 단위당 40원 할인 정상 적용")
    ...
    @Test
    @DisplayName("주유소: 일 1회 한도의 마지막 허용 거래는 적용한다")
    void appliesBenefit003WhenDailyUsageIsLastAllowed() {
        // 적용 가능한 마지막 경계값 또는 최초 경계값을 결제 상황에 넣어 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit003Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("주유소: 일 1회 사용 후에는 적용하지 않는다")
    void rejectsBenefit003WhenDailyUsageLimitIsExhausted() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit003Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    void calculatesZeroBenefit003ForZeroUsage() {
    ...
    @Test
    @DisplayName("패밀리레스토랑: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("패밀리레스토랑: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("패밀리레스토랑: 월 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("영화: 2000원 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("영화: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("영화: 월 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("영화: 정액 할인은 결제금액을 초과하지 않는다")
    void capsBenefit006FixedDiscountAtPaymentAmount() {
        // 정액 할인액보다 작은 결제금액으로 결제금액 초과 할인 방지 정책을 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit006Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("무이자할부: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
    ...
    @Test
    @DisplayName("테마파크: 월 1회 한도의 마지막 허용 거래는 적용한다")
    void appliesBenefit008WhenMonthlyUsageIsLastAllowed() {
        // 적용 가능한 마지막 경계값 또는 최초 경계값을 결제 상황에 넣어 계산한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit008Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("테마파크: 월 1회 사용 후에는 적용하지 않는다")
    void rejectsBenefit008WhenMonthlyUsageLimitIsExhausted() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit008Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
    ...
    @Test
    @DisplayName("보험사: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
