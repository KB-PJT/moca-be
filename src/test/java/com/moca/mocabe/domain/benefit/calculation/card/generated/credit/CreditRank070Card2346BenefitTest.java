...
@DisplayName("신용 70위 BC 바로 클리어 플러스")
class CreditRank070Card2346BenefitTest {
    ...
    @Test
    @DisplayName("점심: 7.000000000000001% 할인 정상 적용")
    ...
    @Test
    @DisplayName("점심: 전월 실적 150,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("점심: 전월 실적 150,000원부터 적용한다")
    ...
    @Test
    @DisplayName("점심: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("대중교통: 7.000000000000001% 할인 정상 적용")
    ...
    @Test
    @DisplayName("대중교통: 전월 실적 150,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("대중교통: 전월 실적 150,000원부터 적용한다")
    ...
    @Test
    @DisplayName("드럭스토어: 전월 실적 150,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("드럭스토어: 전월 실적 150,000원부터 적용한다")
    ...
    @Test
    @DisplayName("무이자할부: 직접 카드 결제 계산 규칙 검토 필요 - 상세 조건에서 완전한 계산 산식을 추출하지 못함")
