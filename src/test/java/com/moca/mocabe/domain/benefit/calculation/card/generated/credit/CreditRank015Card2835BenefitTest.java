...
@DisplayName("신용 15위 신한카드 Discount Plan+")
class CreditRank015Card2835BenefitTest {
    ...
    @Test
    @DisplayName("쇼핑: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("쇼핑: 전월 실적 400,000원부터 적용한다")
    ...
    @Test
    @DisplayName("쇼핑: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("쇼핑: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("쇼핑: 월 5회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("쇼핑: 월 5회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("교통: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("교통: 전월 실적 400,000원부터 적용한다")
    ...
    @Test
    @DisplayName("교통: 1회 인정금액 50,000원 초과분은 혜택에서 제외한다")
    ...
    @Test
    @DisplayName("교통: 월 5회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("교통: 월 5회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 전월 실적 400,000원부터 적용한다")
    ...
    @Test
    @DisplayName("생활: 1회 인정금액 50,000원 초과분은 혜택에서 제외한다")
    ...
    @Test
    @DisplayName("생활: 일 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("생활: 일 1회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 월 5회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("생활: 월 5회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("영화: 5000원 정액 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("영화: 최소 결제금액 2,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("영화: 최소 결제금액 2,000원부터 적용한다")
    ...
    @Test
    @DisplayName("영화: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("영화: 전월 실적 400,000원부터 적용한다")
    ...
    @Test
    @DisplayName("캐시백: 30000원 정액 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("캐시백: 카테고리가 일치하지 않으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("캐시백: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("캐시백: 전월 실적 400,000원부터 적용한다")
    ...
    @Test
    @DisplayName("캐시백: 지정 결제 채널이 아니면 적용하지 않는다")
    void rejectsBenefit008WhenPaymentChannelIsNotEligible() {
        // 미적용 경계값을 결제 상황에 넣어 계산기가 거절 사유를 구분하는지 확인한다.
        BenefitCalculationResult result = fixture.calculator.calculate(
                benefit008Rule(/* 이번 달에 이미 사용한 혜택 */ "0"),
                fixture.context(
