...
@DisplayName("신용 51위 신한카드 Globus")
class CreditRank051Card2532BenefitTest {
    ...
    @Test
    @DisplayName("수수료우대: 1.18% 할인 정상 적용")
    ...
    void floorsBenefit001FractionalReward() {
        ...
        fixture.assertBigDecimalEquals("118", result.rawRewardValue());
    }
