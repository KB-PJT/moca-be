...
@DisplayName("체크 31위 신한카드 플리 체크(산리오캐릭터즈)")
class CheckRank031Card2492BenefitTest {
    ...
    @Test
    @DisplayName("국내외가맹점: 0.3% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("기타: 300000원 정액 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("적립: 300000P 정액 포인트 정상 적용")
