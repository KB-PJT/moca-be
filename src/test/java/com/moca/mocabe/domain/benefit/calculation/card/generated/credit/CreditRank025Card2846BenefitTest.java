...
@DisplayName("신용 25위 클래시 트래블카드")
class CreditRank025Card2846BenefitTest {
    ...
    @Test
    @DisplayName("적립: 전월 실적 1,000,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("적립: 전월 실적 1,000,000원부터 적용한다")
    ...
    @Test
    @DisplayName("적립: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("공항라운지/PP: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
    void classifiesBenefit004() {
        // 계산하지 않는 상세도 누락하지 않고 원본 분류 상태와 제외·검토 사유를 고정한다.
        fixture.assertSourceDetail(
                /* 카드고릴라 카드 ID */ "2846",
                /* 카드 내 혜택 순번 */ 4,
                /* benefit_title */ "공항라운지/PP",
                /* 계산 지원 상태 */ "INFORMATION_ONLY",
                /* 분류 사유 */ "바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택");
    }
