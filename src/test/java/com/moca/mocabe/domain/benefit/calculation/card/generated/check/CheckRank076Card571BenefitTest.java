...
@DisplayName("체크 76위 어디서나 체크카드")
class CheckRank076Card571BenefitTest {
    ...
    @Test
    @DisplayName("주유소: 사용 단위당 40P 포인트 정상 적용")
    ...
    @Test
    @DisplayName("주유소: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("기타: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("기타: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("기타: 정률 혜택의 원 미만 금액을 절사한다")
