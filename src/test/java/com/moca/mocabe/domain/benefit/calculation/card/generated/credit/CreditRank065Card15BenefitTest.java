...
@DisplayName("신용 65위 신한카드 The CLASSIC+")
class CreditRank065Card15BenefitTest {
    ...
    @Test
    @DisplayName("항공마일리지: 직접 카드 결제 계산 규칙 검토 필요 - 선택형/자동맞춤/배수/특수 조건은 별도 사용자 선택 또는 집계가 필요함")
    void classifiesBenefit002() {
        // 계산하지 않는 상세도 누락하지 않고 원본 분류 상태와 제외·검토 사유를 고정한다.
        fixture.assertSourceDetail(
                /* 카드고릴라 카드 ID */ "15",
                /* 카드 내 혜택 순번 */ 2,
                /* benefit_title */ "항공마일리지",
                /* 계산 지원 상태 */ "DIRECT_OFFLINE_REVIEW_REQUIRED",
                /* 분류 사유 */ "선택형/자동맞춤/배수/특수 조건은 별도 사용자 선택 또는 집계가 필요함");
    }
    ...
    @Test
    @DisplayName("면세점: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("면세점: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("면세점: 신규 발급 유예기간에는 전월 실적 0원도 적용한다")
    ...
    @Test
    @DisplayName("주유소: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("주유소: 전월 실적 300,000원부터 적용한다")
    ...
    void calculatesZeroBenefit005ForZeroUsage() {
    ...
    @Test
    @DisplayName("카페: 직접 카드 결제 계산 규칙 검토 필요 - 상세 조건에서 완전한 계산 산식을 추출하지 못함")
