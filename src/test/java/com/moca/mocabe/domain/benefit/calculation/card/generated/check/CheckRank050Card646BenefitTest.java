...
@DisplayName("체크 50위 신한카드 Deep Dream 체크(미니언즈)")
class CheckRank050Card646BenefitTest {
    ...
    void calculatesZeroBenefit004ForZeroUsage() {
    ...
    @Test
    @DisplayName("택시: 1000P 정액 할인 정상 적용")
