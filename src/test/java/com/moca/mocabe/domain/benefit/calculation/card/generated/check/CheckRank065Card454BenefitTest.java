...
@DisplayName("체크 65위 가온 올포인트 체크카드")
class CheckRank065Card454BenefitTest {
    ...
    @Test
    @DisplayName("모든가맹점: 0.2% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("모든가맹점: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("모든가맹점: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("카페/디저트: 0.2% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("카페/디저트: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페/디저트: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("교통: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("교통: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("대형마트: 0.8% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("대형마트: 최소 결제금액 30,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("대형마트: 최소 결제금액 30,000원부터 적용한다")
    ...
    void floorsBenefit006FractionalReward() {
        ...
        // 카드 혜택은 원 미만 금액을 올림하지 않고 버린 결과와 같아야 한다.
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("240", result.rawRewardValue());
    }

    @Test
    @DisplayName("주유: 0.8% 포인트 정상 적용")
    ...
    @Test
    @DisplayName("주유: 최소 결제금액 30,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("주유: 최소 결제금액 30,000원부터 적용한다")
