...
@DisplayName("신용 86위 the OPUS silver")
class CreditRank086Card2902BenefitTest {
    ...
    @Test
    @DisplayName("공항: 30000원 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("공항: 전월 실적 500,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("공항: 전월 실적 500,000원부터 적용한다")
    ...
    @Test
    @DisplayName("공항: 정액 할인은 결제금액을 초과하지 않는다")
