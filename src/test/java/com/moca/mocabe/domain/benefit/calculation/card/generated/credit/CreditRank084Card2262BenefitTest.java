...
@DisplayName("신용 84위 LOCA LIKIT Eat")
class CreditRank084Card2262BenefitTest {
    ...
    @Test
    @DisplayName("일반음식점: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("일반음식점: 전월 실적 400,000원부터 적용한다")
    ...
    @Test
    @DisplayName("카페: 전월 실적 400,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페: 전월 실적 400,000원부터 적용한다")
