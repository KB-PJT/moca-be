...
@DisplayName("체크 74위 신한카드 Pick E 체크")
class CheckRank074Card2528BenefitTest {
    ...
    @Test
    @DisplayName("카페: 월 3회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("카페: 월 3회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("해외이용: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("해외이용: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("생활: 월 3회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("생활: 월 3회 사용 후에는 적용하지 않는다")
