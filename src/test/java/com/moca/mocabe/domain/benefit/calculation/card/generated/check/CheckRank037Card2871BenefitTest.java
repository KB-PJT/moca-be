...
@DisplayName("체크 37위 우체국 LUCK-KEY 체크카드")
class CheckRank037Card2871BenefitTest {
    ...
    @Test
    @DisplayName("편의점: 최소 결제금액 5,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("편의점: 최소 결제금액 5,000원부터 적용한다")
    ...
    @Test
    @DisplayName("편의점: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("편의점: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("패스트푸드: 7.000000000000001% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("패스트푸드: 최소 결제금액 7,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("패스트푸드: 최소 결제금액 7,000원부터 적용한다")
    ...
    @Test
    @DisplayName("패스트푸드: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("패스트푸드: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("카페: 7.000000000000001% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("카페: 최소 결제금액 7,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페: 최소 결제금액 7,000원부터 적용한다")
    ...
    @Test
    @DisplayName("카페: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("카페: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("생활: 7.000000000000001% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("생활: 최소 결제금액 10,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 최소 결제금액 10,000원부터 적용한다")
    ...
    @Test
    @DisplayName("생활: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("생활: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("생활: 제외 가맹점에서는 적용하지 않는다")
    ...
    @Test
    @DisplayName("학원: 7.000000000000001% 캐시백 정상 적용")
    ...
    @Test
    @DisplayName("학원: 최소 결제금액 10,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("학원: 최소 결제금액 10,000원부터 적용한다")
    ...
    @Test
    @DisplayName("학원: 전월 실적 100,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("학원: 전월 실적 100,000원부터 적용한다")
    ...
    @Test
    @DisplayName("학원: 정률 혜택의 원 미만 금액을 절사한다")
