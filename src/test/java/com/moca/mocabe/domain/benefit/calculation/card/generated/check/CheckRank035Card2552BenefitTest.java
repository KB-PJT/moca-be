...
@DisplayName("체크 35위 카드의정석 EVERY CHECK")
class CheckRank035Card2552BenefitTest {
    ...
    @Test
    @DisplayName("무실적: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    @Test
    @DisplayName("적립: 3000P 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("적립: 10000P 정액 포인트 정상 적용")
    ...
    @Test
    @DisplayName("적립: 월 1회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("적립: 월 1회 사용 후에는 적용하지 않는다")
