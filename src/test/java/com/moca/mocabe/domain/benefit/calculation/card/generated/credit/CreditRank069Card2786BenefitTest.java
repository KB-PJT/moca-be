...
@DisplayName("신용 69위 힐튼 아너스 아멕스 프리미엄")
class CreditRank069Card2786BenefitTest {

    private final CardBenefitTestFixture fixture = new CardBenefitTestFixture();

    @Test
    @DisplayName("적립: 1,500원당 2마일 적립 정상 적용")
    ...
    @Test
    @DisplayName("호텔: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
