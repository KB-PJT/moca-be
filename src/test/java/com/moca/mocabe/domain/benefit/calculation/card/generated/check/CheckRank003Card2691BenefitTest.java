...
@DisplayName("체크 3위 트래블러스 체크카드(토심이)")
class CheckRank003Card2691BenefitTest {
    ...
    @Test
    @DisplayName("해외: 정보성 혜택 - 바우처·수수료·무이자할부 등 결제금액 역산 대상이 아닌 혜택")
    ...
    @Test
    @DisplayName("베이커리: 직접 카드 결제 계산 규칙 검토 필요 - 상세 조건에서 완전한 계산 산식을 추출하지 못함")
    ...
    @Test
    @DisplayName("기차: 직접 카드 결제 계산 규칙 검토 필요 - 상세 조건에서 완전한 계산 산식을 추출하지 못함")
    ...
    @Test
    @DisplayName("고속버스: 직접 카드 결제 계산 규칙 검토 필요 - 상세 조건에서 완전한 계산 산식을 추출하지 못함")
    ...
    @Test
    @DisplayName("자동차: 500원 정액 할인 정상 적용")
    ...
    @Test
    @DisplayName("자동차: 최소 결제금액 1,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("자동차: 최소 결제금액 1,000원부터 적용한다")
    ...
    @Test
    @DisplayName("자동차: 전월 실적 200,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("자동차: 전월 실적 200,000원부터 적용한다")
    ...
    @Test
    @DisplayName("자동차: 월 6회 한도의 마지막 허용 거래는 적용한다")
    ...
    @Test
    @DisplayName("자동차: 월 6회 사용 후에는 적용하지 않는다")
    ...
    @Test
    @DisplayName("푸드: 직접 카드 결제 계산 규칙 검토 필요 - 상세 조건에서 완전한 계산 산식을 추출하지 못함")
