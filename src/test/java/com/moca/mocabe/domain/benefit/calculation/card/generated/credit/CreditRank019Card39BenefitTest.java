...
@DisplayName("신용 19위 신한카드 Deep Oil")
class CreditRank019Card39BenefitTest {
    ...
    @Test
    @DisplayName("주유: 직접 카드 결제 계산 규칙 검토 필요 - 선택형/자동맞춤/배수/특수 조건은 별도 사용자 선택 또는 집계가 필요함")
    ...
    @Test
    @DisplayName("자동차/하이패스: 전월 실적 300,000원보다 1원 적으면 적용하지 않는다")
    ...
    @Test
    @DisplayName("자동차/하이패스: 전월 실적 300,000원부터 적용한다")
    ...
    @Test
    @DisplayName("자동차/하이패스: 정률 혜택의 원 미만 금액을 절사한다")
    ...
    /**
     * benefit_title=자동차/하이패스의 계산 조건을 만든다.
     *
