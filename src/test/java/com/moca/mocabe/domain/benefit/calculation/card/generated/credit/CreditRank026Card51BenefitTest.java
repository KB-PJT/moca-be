...
@DisplayName("신용 26위 삼성카드 taptap O")
class CreditRank026Card51BenefitTest {
    ...
    @Test
    @DisplayName("해외: 제외 가맹점에서는 적용하지 않는다")
    ...
    void floorsBenefit005FractionalReward() {
        ...
        // 카드 혜택은 원 미만 금액을 올림하지 않고 버린 결과와 같아야 한다.
        fixture.assertApplied(result);
        fixture.assertBigDecimalEquals("130", result.rawRewardValue());
    }
