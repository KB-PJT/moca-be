...
@DisplayName("체크 36위 카카오페이 신한 체크카드")
class CheckRank036Card286BenefitTest {
    ...
    @Test
    @DisplayName("영화: 3000P 정액 포인트 정상 적용")
    ...
    @Test
    @DisplayName("해외: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
