...
@DisplayName("체크 53위 모두의 일상 체크카드")
class CheckRank053Card690BenefitTest {

    private final CardBenefitTestFixture fixture = new CardBenefitTestFixture();

    @Test
    @DisplayName("모든가맹점: 온라인·간편결제 범위 제외 - 온라인·앱·배달·간편결제·자동납부 전용 혜택")
    ...
    @Test
    @DisplayName("해외: 직접 카드 결제 계산 규칙 검토 필요 - 선택형/자동맞춤/배수/특수 조건은 별도 사용자 선택 또는 집계가 필요함")
