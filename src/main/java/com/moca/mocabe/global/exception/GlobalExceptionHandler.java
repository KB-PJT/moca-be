...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiErrorResponse> handleCardLinkNotFound(
      CardLinkNotFoundException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleUserCardNotFound(
      UserCardNotFoundException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleInvalidCardSelection(
      InvalidCardSelectionException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleInvalidSyncPeriod(
      InvalidSyncPeriodException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleInvalidHomeQuery(
      InvalidHomeQueryException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleHomeDataNotFound(
      HomeDataNotFoundException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleInvalidMerchantQuery(
      InvalidMerchantQueryException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleCardCredentialRequired(
    ...
    return error(
        HttpStatus.BAD_REQUEST,
        "CARD_CREDENTIAL_REQUIRED",
        exception.getMessage(),
        exception.getFields());
  }

  @ExceptionHandler(CardNumberMismatchException.class)
  public ResponseEntity<ApiErrorResponse> handleCardNumberMismatch(
      CardNumberMismatchException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleCodefAccountLocked(
      CodefAccountLockedException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleCodefUnavailable(
      CodefUnavailableException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleApprovalSyncFailed(
  ...
  public ResponseEntity<ApiErrorResponse> handlePerformanceSyncFailed(
  ...
  public ResponseEntity<ApiErrorResponse> handlePerformanceUnsupported(
  ...
  public ResponseEntity<ApiErrorResponse> handleCardAlreadyLinked(
      CardAlreadyLinkedException exception) {
  ...
  public ResponseEntity<ApiErrorResponse> handleDataAccess(DataAccessException exception) {
    ...
    return error(
        HttpStatus.SERVICE_UNAVAILABLE, "DATA_STORE_UNAVAILABLE", "데이터 저장소에 일시적으로 연결할 수 없습니다.");
  }
  ...
  /**
   * 로그에 안전하게 남길 수 있는 예외 요약을 만든다(CWE-532). 예외/원인의 클래스명과, 원인이 SQLException이면 SQLState까지만 담고, 메시지나
   * 스택트레이스처럼 쿼리·바인딩 값이 섞일 수 있는 원문은 포함하지 않는다.
   */
