...
public class RecentBenefitRow {
    ...
    public void setBenefitHistoryId(String benefitHistoryId) { this.benefitHistoryId = benefitHistoryId; }
    ...
    public void setBenefitAmount(long benefitAmount) { this.benefitAmount = benefitAmount; }
