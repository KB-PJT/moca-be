...
public interface BenefitCalculationMapper {
    List<BenefitApprovalRow> findApprovalsForCalculation(@Param("approvalIds") List<String> approvalIds);

    List<SimpleBenefitRuleRow> findSimpleRulesForUserCard(@Param("userCardId") String userCardId,
                                                          @Param("usageDate") LocalDate usageDate);

    Integer findPreviousMonthSpend(@Param("userCardId") String userCardId,
    ...
    MonthlyBenefitLimit findApplicableMonthlyRewardLimit(@Param("offerId") String offerId,
                                                         @Param("usageDate") LocalDate usageDate,
    ...
    List<BigDecimal> findConfirmedMonthlyRewardsForUpdate(@Param("userCardId") String userCardId,
    ...
    void insertConfirmedUsage(@Param("usageId") String usageId,
    ...
    void insertCalculationOutcome(@Param("outcomeId") String outcomeId,
                                  @Param("userCardId") String userCardId,
                                  @Param("approvalId") String approvalId,
                                  @Param("offerId") String offerId,
                                  @Param("ruleId") String ruleId,
