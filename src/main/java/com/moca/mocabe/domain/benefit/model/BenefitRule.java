 ...
 *
 * <p>DB에 저장된 혜택 룰 한 건을 애플리케이션 계산 모델로 옮긴 형태이며,
 * 프로모션성 예외 조건은 별도 조건 테이블에서 검증하거나 안내 문구로 처리한다.
 */
public record BenefitRule(
    ...
    public BenefitRule {
        ...
        maximumBenefitBaseAmount = maximumBenefitBaseAmount == null ? BigDecimal.ZERO : maximumBenefitBaseAmount;
        minimumPaymentAmount = minimumPaymentAmount == null ? BigDecimal.ZERO : minimumPaymentAmount;
        requiredPreviousMonthSpend = requiredPreviousMonthSpend == null ? BigDecimal.ZERO : requiredPreviousMonthSpend;
